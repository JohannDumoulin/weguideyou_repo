                    ...
                    <form class="updatePanel-main" method="POST" action="{{route('profile.update', Auth::user()->id)}}">
                        ...
                        @if($status === 'NSO' || $status === 'SO' || $status === 'PRO')
                            <div class="updatePanel-sector">
                                <div>
                                    <label>
                                        <input name="title" type="text" placeholder="Titre" class="form-control @error('city') is-invalid @enderror" maxlength="50" value="{{ Auth::user()->title ?? '' }}" autofocus>
                                    </label>
                                </div>
                                <div>
                        ...
                        <div class="updatePanel-description">
                            <label>
                                <textarea name="description" placeholder="Description"   class="profile-description" rows="5" cols="30" maxlength="280">{{Auth::user()->description ?? ''}}</textarea>
                            </label>
                        </div>
                        <div>
                        ...
                        <div class="profileDetails">
                            ...
                            @if($status === 'NSO' || $status === 'SO' || $status === 'PRO')
                                ...
                                {{--<div class="profile-job">
                                    <p>{{ Auth::user()->job ?? Lang::get('A compléter')}} - <a href="#">{{ Auth::user()->city ?? Lang::get('A compléter')}}</a></p>
                                </div>--}}
                            @endif
