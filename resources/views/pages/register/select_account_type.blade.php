        ...
        <div class="wrap">
            ...
            <div class="selectTypeAccount">
                <div>
                    ...
                    @include('components.buttonLink', ['link' => 'register/pro'], ['text' => 'Choisir'])
                </div>
                <div>
                    <h2>Organisme non sportif</h2>
                    @include('components.buttonLink', ['link' => 'register/nso'], ['text' => 'Choisir'])
                </div>
                <div>
                    <h2>Organisme sportif</h2>
                    @include('components.buttonLink', ['link' => 'register/so'], ['text' => 'Choisir'])
                </div>
                <div>
                    <h2>Particulier</h2>
                    @include('components.buttonLink', ['link' => 'register/par'], ['text' => 'Choisir'])
                </div>
            </div>
        </div>
    </section>
